...
console.log(el); //every cell

if (_this.settings.columns.length === 0 || _this.settings.columns.indexOf(d) !== -1) {
var $el = $(el);
var v_dato = $el.html();

var v_group_id = $el.attr('group-id');
if(typeof arr[d] != 'undefined' && 'dato' in arr[d] && arr[d].dato == v_dato && arr[d].group_id == v_group_id) {
...
arr[d] = {dato: v_dato, elem: $el, group_id: v_group_id };
